...
class SensorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Sensor::create([
            ...
            'temperature' => $sensorKey->id != 12 ? $request->input('temperature') : null,
            'humidity' => $sensorKey->id != 12 ? $request->input('humidity') : null,
            'air_humidity' => $sensorKey->id == 12 ? $request->input('humidity') : $request->input('air_humidity'),
            'air_temperature' => $sensorKey->id == 12 ? $request->input('temperature') : $request->input('air_temperature'),
            'light' => $request->input('light'),
